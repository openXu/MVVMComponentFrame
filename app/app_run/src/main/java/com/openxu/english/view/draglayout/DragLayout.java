package com.openxu.english.view.draglayout;
...
//				new YScrollDetector());
	...
	protected void onFinishInflate() {
		...
		if (isShowShadow) {
			...
			iv_shadow.setImageResource(R.drawable.view_draglayout_shadow);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		vg_left.layout(0, 0, width, height);
		vg_main.layout(mainLeft, 0, mainLeft + width, height);
//		MyUtil.LOG_V(TAG, "vg_left:"+0+","+0+","+ width+","+height);
//		MyUtil.LOG_V(TAG, "vg_main:"+mainLeft+","+0+","+ ( mainLeft + width)+","+height);
	}

	public void setViewPaget(ViewPager viewPager) {
...
//	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if(viewPager.getCurrentItem()!=0){
			...
			return dragHelper.shouldInterceptTouchEvent(ev)&&result;
		}
	}
