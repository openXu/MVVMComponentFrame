package com.openxu.english.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(downType == TYPE_1){
			if(getCount() == position+1){
				viewHolder.layout.setBackgroundResource(R.drawable.spinner_last_item);
			}else{
				viewHolder.layout.setBackgroundResource(R.drawable.spinner_item);
			}
		}else{
			if(position == 0){
				viewHolder.layout.setBackgroundResource(R.drawable.spinner_first_item);
