...
public class GetWordDBHelper{
	...
	public static DBHelper getInstance(Context context, String dbName) {
		new GetWordDBHelper(context, dbName);
		return helper;
	};
	
	private GetWordDBHelper(Context context, String dbName){
	...
	public static class DBHelper extends SQLiteOpenHelper {
		...
		public DBHelper(Context context) {
			super(context, GetWordDBHelper.dbName, null, CURRENT_VERSION);
		}
