...
public class UpdateBookDialog extends ItotemBaseDialog {

	private Listener listener;
	private TextView tv_delete, tv_update, tv_cancel;

	public UpdateBookDialog(Context context) {
		super(context, R.layout.dialog_update_mybook, R.style.ItotemTheme_Dialog);
	}
	...
	protected void initView() {
		...
		tv_update.setTextColor(context.getResources().getColor(MyApplication.pf.title_bg));
		...
		tv_update.setBackgroundResource(MyApplication.pf.item_selector);
