 ...
 */
package com.openxu.view.WaterDrop;
...
import com.openxu.view.util.WaterDropViewUtils;
...
public class WaterDropListViewHeader extends FrameLayout {
    ...
    public void setVisiableHeight(int height) {
        ...
        if(mState == STATE.stretch){
            float pullOffset = (float) WaterDropViewUtils.mapValueFromRangeToRange(height, stretchHeight, readyHeight, 0, 1);
