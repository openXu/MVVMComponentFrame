...
public final class XBarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (XUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, XUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = XUtils.getApp().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = XUtils.getApp()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(XUtils.getApp()).hasPermanentMenuKey();
