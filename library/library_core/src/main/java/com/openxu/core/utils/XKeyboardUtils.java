...
/**
 * Author: openXu
 * Time: 2019/3/14 11:48
 * class: FKeyboardUtils
 * Description: 键盘工具
 *
 * showSoftInput                     : 显示软键盘
 * hideSoftInput                     : 隐藏软键盘
 ...
 */
public final class XKeyboardUtils {
    ...
    private static int getDecorViewInvisibleHeight(final Activity activity) {
        ...
        Log.d("FKeyboardUtils", "getDecorViewInvisibleHeight: "
...
//        window.setSoftInputMode(softInputMode & ~WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
    ...
    private static int getContentViewInvisibleHeight(final Activity activity) {
        ...
        Log.d("FKeyboardUtils", "getContentViewInvisibleHeight: "
    ...
    public static void clickBlankArea2HideSoftInput() {
        Log.i("FKeyboardUtils", "Please refer to the following code.");
        /*
        @Override
