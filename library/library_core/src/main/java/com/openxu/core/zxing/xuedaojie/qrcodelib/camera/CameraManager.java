...
package com.openxu.core.zxing.xuedaojie.qrcodelib.camera;
...
public final class CameraManager {
    ...
    public Rect getFramingRect(int offsetX, int offsetY) {
        ...
        if (framingRect == null) {
            ...
            Log.e("TAG", "screenResolution.x===="+screenResolution.x);
            Log.e("TAG", "screenResolution.x===="+screenResolution.y);
...
//                    topOffset + height + offsetY);
            ...
            int leftOffsetX=offsetX/2;
            int topOffsetX=offsetY/2;
            framingRect = new Rect(leftOffsetX,
                    topOffsetX,
                    screenResolution.x-leftOffsetX,
                    screenResolution.y-topOffsetX);
