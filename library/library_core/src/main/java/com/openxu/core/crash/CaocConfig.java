 ...
 * class: CaocConfig
 * Description:
 * https://github.com/Ereza/CustomActivityOnCrash/blob/master/library/src/main/java/cat/ereza/customactivityoncrash/config/CaocConfig.java
 */
public class CaocConfig implements Serializable {
    ...
    public static class Builder {
         ...
         * The default is R.drawable.lib_icon_crash_error (a cute upside-down bug).
         */
        @NonNull
