...
public class NetworkManager1 {
    ...
    private static NetworkManager1 INSTANCE;

    static {
        INSTANCE = new NetworkManager1();
    }
    ...
    public class RequstBuilder<S> {
       ...
       public S build() {
          ...
          /* NetworkManager.getInstance().create(ApiService.class)
                   ...
                   .subscribe(new Consumer<FanyiResult>() {
                       @Override
                       public void accept(FanyiResult result) throws Exception {
